  ...
  return (
    <div className="footer" id="contact">
      ...
      <div className="row-group">
        <a href="www.twitter.com/hudeh30"  className="social"><TwitterIcon className="icon" /></a>
        <a href="www.instagram.com/hudeh30"  className="social"><InstagramIcon className="icon"/></a>
        <a href="www.linkedin.com/in/henry-udezuligbo"  className="social"><LinkedInIcon className="icon"/></a>
